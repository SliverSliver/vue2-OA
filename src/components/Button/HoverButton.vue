      ...
      classes() {
        ...
        return [
          `${hoverClass}`,
          {
            ...
            [`${hoverClass}-${this.type}`]: !!this.type &&
            (this.type === 'lean' || this.type === 'arrow' || this.type === 'change'),
            [`${hoverClass}-${this.type}` + ' ' + `${hoverClass}-${this.type}-${this.shap}`]: !!this.type &&
            oneOf(this.type, ['arrow', 'change']),
